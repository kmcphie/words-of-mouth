...
def get_wise(reflection, wisdom):
    ...
    message = client.messages.create(
        ...
        max_tokens=1000,
        temperature=1,
        system=f"You are a wise guidance counselor. You are helping someone with what is on their {context_category} by telling them a very brief story or quote that is relevant. Rap your response.",
        messages=[
            {
                "role": "user",
                "content": [
                    {
                        "type": "text",
                        "text": f"""Briefly offer thoughts on the reflection below, 1-2 sentences or a quote max. Sound like you are being {wisdom}.
